...
RAW_PDF_DIR = os.getenv("RAW_DATA_DIR", "./data/raw")
PROCESSED_PDF_DIR = os.getenv("PROCESSED_PDF_DIR", "./data/processed_pdf")
LOG_DIR = os.getenv("LOG_DIR", "./logs/processed_pdf_log")
